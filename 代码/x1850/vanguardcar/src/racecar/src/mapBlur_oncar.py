...
class mapBlur:
    ...
    def mapBlur(self):
        ...
        # 读取图像并转换为灰度图像
        img = cv2.imread('/home/scnu-car/car2023_ws/src/racecar/map/mymap.pgm')
        img_cut = img[280:430 + 1, 390:760 + 1] #outer
        # img_cut = img[325:390 + 1, 435:720 + 1]  #inner
        ...
        #标志被保留的部分，即增强
        # for i in range(len(blk_contour)):
        #     print(blk_contour[i])
        # print(blk_contour[0][0])
        ...
        saved_img = cv2.cvtColor(blured_img, cv2.COLOR_BGR2GRAY)
        cv2.imwrite('/home/scnu-car/car2023_ws/src/racecar/map/mymap.pgm', saved_img)
        img = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

        cv2.imwrite('/home/scnu-car/car2023_ws/src/racecar/map/originMap.pgm', img)
