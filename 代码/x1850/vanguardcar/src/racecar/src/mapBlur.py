...
class mapBlur:
    ...
    def mapBlur(self):
        # 读取图像并转换为灰度图像
        img = cv2.imread('/home/scnu-car/vanguardcar/src/racecar/map/mymap.pgm')
        ...
        cv2.imwrite('/home/scnu-car/vanguardcar/src/racecar/map/mymap.pgm', saved_img)
        img = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

        cv2.imwrite('/home/scnu-car/vanguardcar/src/racecar/map/originMap.pgm', img)
